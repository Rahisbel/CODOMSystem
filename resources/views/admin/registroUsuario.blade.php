            ...
            <div class="card border-dark mb-3" style="max-width">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('almacenarUsuario') }}">
                        ...
                        <div class="form-group row">
                            <label for="exampleFormControlSelect1" class="col-md-4 col-form-label text-md-right">Número de propiedad</label>
                            <select name="property_id" class="form-control col-md-6" id="exampleFormControlSelect1">
